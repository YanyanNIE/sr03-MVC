   ...
   <div class="form-row" >
    ...
    <div class="form-row">
	    <div class="form-group col-md-6">
	      ...
	      <input type="text" class="form-control" id="identity"  name="User identity" value="${row.ident}">
	    </div>
    
	    <div class="form-group col-md-6">
	      <label for="inputStat">Stat</label>
	      <input type="text" class="form-control" id="phone" name="User stat" value="${row.stat}">
	    </div>
    </div>
  </br>
